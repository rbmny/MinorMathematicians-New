...
class fourStudentsVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func fetchPosts(completion: @escaping(_ posts:[Post]) -> ()) {
        let postsRef = Database.database().reference().child("Fourth Grade").child("Posts")
    ...
    @IBAction func onReturnPressed(_ sender: Any){
        performSegue(withIdentifier: "fourStudentReturn", sender: nil)
    }
